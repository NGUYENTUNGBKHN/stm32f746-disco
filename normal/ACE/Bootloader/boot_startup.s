...
*******************************************************************************/
   .weak      NMI_IRQHandler
   .thumb_set NMI_IRQHandler,Default_Handler
  
   .weak      HardFault_IRQHandler
   .thumb_set HardFault_IRQHandler,Default_Handler
  
   .weak      MemManage_IRQHandler
   .thumb_set MemManage_IRQHandler,Default_Handler
  
   .weak      BusFault_IRQHandler
   .thumb_set BusFault_IRQHandler,Default_Handler

   .weak      UsageFault_IRQHandler
   .thumb_set UsageFault_IRQHandler,Default_Handler

   .weak      SVC_IRQHandler
   .thumb_set SVC_IRQHandler,Default_Handler

   .weak      DebugMonitor_IRQHandler
   .thumb_set DebugMonitor_IRQHandler,Default_Handler

   .weak      PendSV_IRQHandler
   .thumb_set PendSV_IRQHandler,Default_Handler
